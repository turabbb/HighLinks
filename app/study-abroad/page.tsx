...
const destinations = [
  ...
  },
  {
    ...
    universities: "300+",
    highlights: ["Tuition-free education", "Strong economy", "Engineering hub"],
    popularCourses: ["Engineering", "Sciences", "Business", "Automotive"],
  },
  {
    country: "Ireland",
    code: "ie",
  ...
  },
  {
    ...
    universities: "20+",
    highlights: ["Safe and welcoming", "Work while studying", "Beautiful landscapes"],
    popularCourses: ["Agriculture", "Tourism", "Engineering", "IT"],
  },
  {
    country: "France",
    code: "fr",
    ...
    universities: "200+",
    highlights: ["Affordable education", "Rich culture", "Grandes écoles"],
    popularCourses: ["Fashion", "Culinary Arts", "Business", "Engineering"],
  },
]
